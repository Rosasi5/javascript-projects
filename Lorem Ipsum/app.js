...
form.addEventListener('submit', function (e) {
    ...
    const value = parseInt(amount.value); //input values are always strings
    ...
    if(isNaN(value) || value <= 0 || value > 9 ){
        ...
        let tempText = text.slice(0, value); //from the first value to the value in the value variable.
